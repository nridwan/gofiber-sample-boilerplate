...
var (
	userAllColumns            = []string{"id", "username", "password", "name", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "password", "name"}
...
// SetUserTokensG removes all previously related items of the
...
// Uses the global database handle.
func (o *User) SetUserTokensG(ctx context.Context, insert bool, related ...*UserToken) error {
	return o.SetUserTokens(ctx, boil.GetContextDB(), insert, related...)
}
...
func (o *User) SetUserTokens(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserToken) error {
	query := "update `user_tokens` set `user_id` = null where `user_id` = ?"
...
// RemoveUserTokensG relationships from objects passed in.
// Removes related items from R.UserTokens (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle.
func (o *User) RemoveUserTokensG(ctx context.Context, related ...*UserToken) error {
	return o.RemoveUserTokens(ctx, boil.GetContextDB(), related...)
}
...
func FindUserG(ctx context.Context, iD uint64, selectCols ...string) (*User, error) {
...
func UserExistsG(ctx context.Context, iD uint64) (bool, error) {
